...
* De manière générale, assurer que l'intégralité du projet existant fonctionne EN LIGNE car le but est de réaliser une application en ligne.
...
* Assurer que chaque bouton (ajout ou modification) du site fonctionne
